...
namespace Xamurai
{
    public class SampleViewModel : BindableBase
    {
        ...
        public Command OnLongPressCommand => new Command<Car>(async (car) =>
        {
            var answer = await App.Current.MainPage.DisplayAlert("Delete", "Do you want to delete?", "YES", "NO");
            if (answer) DeleteCommand.Execute(car);
        });
